...
export function SectionHeading({
  ...
  const titleClassName = isCenter
    ? "mx-auto max-w-[26ch] font-serif text-[1.55rem] leading-[1.08] tracking-[-0.03em] text-text sm:max-w-[30ch] sm:text-[2rem] md:text-[2.15rem] lg:max-w-none lg:text-[2.45rem] lg:whitespace-nowrap"
  ...
  const descriptionClassName = isCenter
    ? "balanced-copy mx-auto mt-4 max-w-4xl text-[13px] leading-7 text-muted sm:text-[14.5px] sm:leading-8"
