...
const rsvpFormSchema = z.object({
  copy: z.object({
    ...
    unableToAttendLabel: z.string(),
    unableToAttendDescription: z.string(),
    ...
    unableToAttendTitle: z.string(),
    unableToAttendNoteDescription: z.string(),
    noteLabel: z.string(),
    submitRsvp: z.string(),
...
export const rsvpFormContent = validateContent(rsvpFormSchema, {
  copy: {
    ...
    unableToAttendLabel: "Unable to Attend",
    unableToAttendDescription: "I/we are sorry we cannot make it.",
